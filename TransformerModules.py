...
'''
	Modules for Transformers
	All require the model that calls them to have a model config with parameters:
		block_size: int, size of context block
		vocab_size: int, number of tokens
		n_layer: int, layers of transformer blocks
		n_head: int, heads of the multihead attention in each attention block
